  ...
  return (
    <header className={classNames(role, s.root, 'stickyTop')}>
      <div className={s.contacts}>
        <p className={s.contacts__title}>Наш Телефон</p>
        <a href='tel:+996 779 168 175' className={s.contacts__link}>+996 779 168 175</a>
        <a href="tel:+996 779 168 175" className={s.contacts__link}>+996 779 168 175</a>
        <p className={s.contacts__time}>
          <svg className={s.contacts__time__icon} xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 15 15" fill="none">
          ...
          работаем с <time>10:00</time> до <time>00:00</time></p>
      </div>
      <div className={s.panel}>
        <div className={s.panel__city}>
          <h3 className={s.panel__city__title}>
            Город:
            <span className={s.highlighted}>Бишкек</span>
          </h3>
        </div>
        <nav className={s.panel__menu}>
